#
#  Be sure to run `pod spec lint aftership-ios.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of aftership-ios in Markdown format.
  ...
  s.homepage     = "https://github.com/AfterShip/aftership-sdk-ios"
  ...
  s.source       = { :git => "https://github.com/AfterShip/aftership-sdk-ios.git", :tag => "1.1.0" }
